                  ...
                  <div class="tab-pane active show" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input @change="updateProfile" type="file"  id="inputProfile" placeholder="Skills">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                          <input @click.prevent="updateInfo" type="submit" class="btn btn-info" name="Update">
                        </div>
                      </div>
                    </form>
                  </div>
...
<script>
    export default {
        ...
        created(){
            ...
            this.$on('AfterCreate', () => this.loadProfile())
        },
        methods:{
            profilePhoto(){
